...
const SITUATIONS = [
  ...
  {
    icon: BarChart3,
    question: "Отчёты об успеваемости — это просто!",
    answer: "Делитесь результатами учеников за пару секунд. Скачайте красивый PDF-отчёт или отправьте родителям персональную ссылку для доступа к статистике — всё наглядно и без лишних регистраций.",
    color: "#426B5C",
  },
  {
    icon: BookOpen,
    ...
    <section className="landing-hero" ref={ref}>
      <div className={`landing-hero__content ${vis ? "landing-reveal" : "landing-reveal--hidden"}`}>
        ...
        <p className="landing-hero__subtitle">
          Расписание, программа курса и отчёты для родителей — всё в одном приложении!
        </p>
